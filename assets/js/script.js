...
function saveScores () {
    ...
    submitButton.on("click", function handleFormSubmit (e) {
        ...
        var addToList = function (arr, newObj) {
        ...
        addToList(savedScoresList, currentPlayer);
...
function renderHighScores () {
    ...
    $.each(savedScoresList, function (i, val) {
        highScoresItem.text(savedScoresList[i].initials + " - " + savedScoresList[i].scores)
    ...
    // If the Clear High Scores button is clicked, clear the savedScoresList.
